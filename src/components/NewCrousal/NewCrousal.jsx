        ...
        <div className="carousel">
                <div className="carousel-item" ref={el => slidesRef.current[0] = el}>
                    <div className="slide-image"
                        style={{ backgroundImage: 'url(/PerCAA-2024/TopCrousalIMages/poornima1.jpg)' }}>
                    </div>
                </div>
            <div className="carousel-item" ref={el => slidesRef.current[1] = el}>
                <div className="slide-image"
                    style={{ backgroundImage: 'url(/PerCAA-2024/TopCrousalIMages/new1.jpeg)' }}>
                </div>
            </div>
            <div className="carousel-item" ref={el => slidesRef.current[2] = el}>
                <div className="slide-image"
                    style={{ backgroundImage: 'url(/PerCAA-2024/TopCrousalIMages/DSC_2109.jpg)' }}>
                </div>
            </div>
            <div className="carousel-item" ref={el => slidesRef.current[3] = el}>
                <div className="slide-image"
                    style={{ backgroundImage: 'url(/PerCAA-2024/TopCrousalIMages/PCE.jpg)' }}>
                </div>
            </div>
        </div>
        </div>
